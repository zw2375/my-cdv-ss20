...
function gotData(incomingData){
  ...
  circles=enteringElements.append("circle")
                            .attr("r",function(d,i){
                              return rScale(d.pop)
                            })
                            .attr("fill",chooseColor)
                            .on("mouseover", function(){return countryName.style("visibility", "visible");})
                            .on("mouseout", function(){return countryName.style("visibility", "hidden");});




var countryName = enteringElements.append("text")
                                    .text(function(d,i){
                                      return d.Country;
                                    })
                                     .attr("x", 10)
